...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__body_ctrl_index_js__ = __webpack_require__(8);
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 5:
                        ...
                        __WEBPACK_IMPORTED_MODULE_3__body_ctrl_index_js__["a" /* default */].hidden();
                        ...
                        __WEBPACK_IMPORTED_MODULE_5__share_js__["a" /* default */].isBackgroundBlur && __WEBPACK_IMPORTED_MODULE_3__body_ctrl_index_js__["a" /* default */].blur({
                            duration: __WEBPACK_IMPORTED_MODULE_5__share_js__["a" /* default */].duration_ms * 2,
                        ...
                        return new Promise(function (resolve, reject) {
                            container_apObj.onfinish = function (e) {
                                ...
                                resolve();
                                __WEBPACK_IMPORTED_MODULE_2__events_js__["b" /* onOpen */].call(EasyModalWindow, {
                                    target: item,
                                    timeStamp: Date.now(),
                                    type: 'open'
                                });
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 9:
                        ...
                        __WEBPACK_IMPORTED_MODULE_2__events_js__["c" /* onReplace */].call(EasyModalWindow, {
                            target: item_new,
                            timeStamp: Date.now(),
                            type: 'replace'
                        });
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        ...
                        (_context3 = __WEBPACK_IMPORTED_MODULE_5__share_js__["a" /* default */].EasyModalWindow, __WEBPACK_IMPORTED_MODULE_2__events_js__["a" /* onClose */]).call(_context3, {
                            target: null,
                            timeStamp: Date.now(),
                            type: 'close'
                        });
                    ...
                    case 3:
                        ...
                        __WEBPACK_IMPORTED_MODULE_3__body_ctrl_index_js__["a" /* default */].focus(); // ボカし解除、ボカしてなければ無反応
                    ...
                    case 8:
                        ...
                        __WEBPACK_IMPORTED_MODULE_3__body_ctrl_index_js__["a" /* default */].view(); // windowサイズ復元
                        // closeイベント
                        (_context4 = __WEBPACK_IMPORTED_MODULE_5__share_js__["a" /* default */].EasyModalWindow, __WEBPACK_IMPORTED_MODULE_2__events_js__["a" /* onClose */]).call(_context4, {
...
var paddingRight_before = ''; // 元のbody.style.paddingRightの値


// bodyサイズをwindow100%に縮小
function hidden() {
    var body_clientWidth_before = body.clientWidth;
    body.classList.add(__WEBPACK_IMPORTED_MODULE_2__style_css___default.a._body); // 前後で消えたスクロールバー分のwidthを計算し、bodyに同サイズのpadding-rightを付与。
    var body_clientWidth_after = body.clientWidth;
...
// module
exports.push([module.i, ".Dwr9BoEvq0HT57k9vOkeS{height:100%;height:100vh;overflow:hidden}", ""]);

// exports
exports.locals = {
	"_body": "Dwr9BoEvq0HT57k9vOkeS"
};
...
// module
exports.push([module.i, "._1hb7ExsIALuP1olhfjTOT9,.ZJSTons1k_f_oN--cGZob,.Kj81HFlmcCeAV0rvkpU13,.UBR9LUvtO4Tlejrq4rDtG,._1aiuL62n-Dh9D22PoJk7Fs{margin:0;padding:0;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}.Kj81HFlmcCeAV0rvkpU13{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-pack:justify;-webkit-justify-content:space-between;-moz-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;position:fixed;top:0;bottom:0;left:0;right:0;overflow:auto;z-index:1}.Kj81HFlmcCeAV0rvkpU13,._1aiuL62n-Dh9D22PoJk7Fs{-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0}._1aiuL62n-Dh9D22PoJk7Fs{-webkit-box-flex:50;-webkit-flex-grow:50;-moz-box-flex:50;-ms-flex-positive:50;flex-grow:50}.ZJSTons1k_f_oN--cGZob{position:fixed;top:1%;top:1vh;right:1%;right:1vw;padding:4.8px;padding:.3rem;color:#fff;font-size:25.6px;font-size:1.6rem;cursor:default;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.ZJSTons1k_f_oN--cGZob,.ZJSTons1k_f_oN--cGZob:hover{-webkit-transition:.3s;-o-transition:.3s;-moz-transition:.3s;transition:.3s}.ZJSTons1k_f_oN--cGZob:hover{color:#b22222}._1hb7ExsIALuP1olhfjTOT9{max-width:100%;-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0}.UBR9LUvtO4Tlejrq4rDtG{-webkit-box-flex:50;-webkit-flex-grow:50;-moz-box-flex:50;-ms-flex-positive:50;flex-grow:50}", ""]);
